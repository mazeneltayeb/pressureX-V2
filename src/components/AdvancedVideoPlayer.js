...
const AdvancedVideoPlayer = ({
  ...
  const isVideoRight = layout === 'right-video';
...
نعمل مع أفضل المصانع والموردين لضمان معايير الجودة والأمان.
هدفنا هو تقديم خدمة مميزة تضمن لعملائنا الثقة والاعتمادية في كل تعامل.
      </p>
